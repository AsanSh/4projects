      ...
      <div className="flex-1 flex flex-col min-w-0 overflow-hidden">
        ...
        <header className="h-14 bg-white border-b border-gray-100 flex items-center px-5 gap-3 flex-shrink-0 relative z-50 shadow-sm">
                    ...
                    <Link key={m.id} href={dashboardHref}>
                      <div
                        className={cn(
                          ...
                          m.id === activeModuleId ? "bg-blue-50 text-blue-900" : "hover:bg-gray-50 text-gray-900"
                        )}
          ...
          <div className="flex-1 max-w-lg relative">
            ...
            <input
              type="text"
              className="w-full pl-9 pr-14 py-1.5 text-sm bg-gray-50 border border-gray-200 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-50 focus:border-blue-200 transition-all text-gray-700 placeholder-gray-400"
