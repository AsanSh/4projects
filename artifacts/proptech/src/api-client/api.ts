...
export const getListCounterpartiesUrl = (params?: ListCounterpartiesParams) => {
  ...
  return stringifiedParams.length > 0
    ? `/counterparties?${stringifiedParams}`
    : `/counterparties`;
};
...
export const getListCounterpartiesQueryKey = (
  ...
  return [`/counterparties`, ...(params ? [params] : [])] as const;
};
...
export const getGetCounterpartyQueryKey = (id: number) => {
  return [`/counterparties/${id}`] as const;
};
...
export const getListContractsQueryKey = (params?: ListContractsParams) => {
  return [`/contracts`, ...(params ? [params] : [])] as const;
};
...
export const getGetImportJobQueryKey = (id: number) => {
  return [`/import/jobs/${id}`] as const;
};
...
export const getListTenantsUrl = (params?: ListTenantsParams) => {
  ...
  return stringifiedParams.length > 0
    ? `/rental/tenants?${stringifiedParams}`
    : `/rental/tenants`;
};
...
export const getListTenantsQueryKey = (params?: ListTenantsParams) => {
  return [`/rental/tenants`, ...(params ? [params] : [])] as const;
};
...
export const getGetTenantQueryKey = (id: number) => {
  return [`/rental/tenants/${id}`] as const;
};
...
export const getListLeaseContractsUrl = (params?: ListLeaseContractsParams) => {
  ...
  return stringifiedParams.length > 0
    ? `/rental/contracts?${stringifiedParams}`
    : `/rental/contracts`;
};
...
export const getListLeaseContractsQueryKey = (
  ...
  return [`/rental/contracts`, ...(params ? [params] : [])] as const;
};
...
export const getGetLeaseContractQueryKey = (id: number) => {
  return [`/rental/contracts/${id}`] as const;
};
...
export const getListAccrualsUrl = (params?: ListAccrualsParams) => {
  ...
  return stringifiedParams.length > 0
    ? `/rental/accruals?${stringifiedParams}`
    : `/rental/accruals`;
};
...
export const getListAccrualsQueryKey = (params?: ListAccrualsParams) => {
  return [`/rental/accruals`, ...(params ? [params] : [])] as const;
};
...
export const getRecalculateAccrualsUrl = () => {
  return `/rental/accruals/recalculate`;
};
...
export const getListPaymentsUrl = (params?: ListPaymentsParams) => {
  ...
  return stringifiedParams.length > 0
    ? `/rental/payments?${stringifiedParams}`
    : `/rental/payments`;
};
...
export const getListPaymentsQueryKey = (params?: ListPaymentsParams) => {
  return [`/rental/payments`, ...(params ? [params] : [])] as const;
};
...
export const getListDepositsUrl = (params?: ListDepositsParams) => {
  ...
  return stringifiedParams.length > 0
    ? `/rental/deposits?${stringifiedParams}`
    : `/rental/deposits`;
};
...
export const getListDepositsQueryKey = (params?: ListDepositsParams) => {
  return [`/rental/deposits`, ...(params ? [params] : [])] as const;
};
...
export const getListExpensesUrl = (params?: ListExpensesParams) => {
  ...
  return stringifiedParams.length > 0
    ? `/rental/expenses?${stringifiedParams}`
    : `/rental/expenses`;
};
...
export const getListExpensesQueryKey = (params?: ListExpensesParams) => {
  return [`/rental/expenses`, ...(params ? [params] : [])] as const;
};
...
export const getListRentalPropertiesUrl = (
  ...
  return stringifiedParams.length > 0
    ? `/rental/properties?${stringifiedParams}`
    : `/rental/properties`;
};
...
export const getListRentalPropertiesQueryKey = (
  ...
  return [`/rental/properties`, ...(params ? [params] : [])] as const;
};
...
export const getActivateRentalPropertyUrl = (id: number) => {
  return `/rental/properties/${id}/activate`;
};
...
export const getGetPropertyPerformanceUrl = (id: number) => {
  return `/rental/properties/${id}/performance`;
};
...
export const getGetPropertyPerformanceQueryKey = (id: number) => {
  return [`/rental/properties/${id}/performance`] as const;
};
...
export const getListOwnerStatementsUrl = (
  ...
  return stringifiedParams.length > 0
    ? `/rental/statements?${stringifiedParams}`
    : `/rental/statements`;
};
...
export const getListOwnerStatementsQueryKey = (
  ...
  return [`/rental/statements`, ...(params ? [params] : [])] as const;
};
...
export const getGenerateOwnerStatementUrl = () => {
  return `/rental/statements/generate`;
};
...
export const getGetDashboardActivityUrl = (
  ...
  return stringifiedParams.length > 0
    ? `/dashboard/activity?${stringifiedParams}`
    : `/dashboard/activity`;
};
...
export const getGetDashboardActivityQueryKey = (
  ...
  return [`/dashboard/activity`, ...(params ? [params] : [])] as const;
};
...
export const getGetRentalOverviewUrl = () => {
  return `/dashboard/rental-overview`;
};
...
export const getGetRentalOverviewQueryKey = () => {
  return [`/dashboard/rental-overview`] as const;
};
