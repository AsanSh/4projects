...
import {
  Building2, DollarSign, Calendar, FileText, CreditCard,
  Home, CheckCircle, Clock, AlertCircle, Download, Phone, Mail, LogOut
} from "lucide-react";
...
export default function ClientDashboard() {
  ...
  const clientData = {
    ...
    documents: [
      { id: 1, name: "Договор купли-продажи", date: "2026-01-10", size: "2.4 MB", type: "pdf" },
      { id: 2, name: "График платежей", date: "2026-01-10", size: "145 KB", type: "xlsx" },
      { id: 3, name: "План квартиры", date: "2026-01-05", size: "890 KB", type: "pdf" },
    ],
  };
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          <Card className="p-6 bg-gradient-to-br from-blue-500 to-purple-700 text-white shadow-lg">
            <div className="flex items-center justify-between mb-4">
              ...
              <Badge className="bg-white/20 text-white border-0">Забронирован</Badge>
            </div>
          ...
          <Card className="p-6 bg-gradient-to-br from-teal-500 to-teal-700 text-white shadow-lg">
            ...
            <div className="text-3xl font-bold mb-2">
              {new Intl.NumberFormat('ru-RU', { notation: 'compact' }).format(unit.paidAmount)} ₸
            </div>
            <div className="text-teal-100 text-sm mb-3">
              Оплачено из {new Intl.NumberFormat('ru-RU', { notation: 'compact' }).format(unit.totalPrice)} ₸
            </div>
          ...
          <Card className="p-6 bg-gradient-to-br from-orange-500 to-orange-700 text-white shadow-lg">
            <div className="flex items-center justify-between mb-4">
              ...
              <Badge className="bg-white/20 text-white border-0">Следующий</Badge>
            </div>
            <div className="text-3xl font-bold mb-2">
              {nextPayment ? new Intl.NumberFormat('ru-RU', { notation: 'compact' }).format(nextPayment.amount) : '0'} ₸
            </div>
            <div className="text-orange-100 text-sm mb-1">Платеж до</div>
            <div className="text-xl font-semibold">
              {nextPayment ? new Date(nextPayment.date).toLocaleDateString('ru-RU', { day: 'numeric', month: 'long' }) : '-'}
            </div>
          </Card>
        </div>
        ...
        <Tabs defaultValue="payments" className="space-y-6">
          ...
          <TabsContent value="payments">
            <Card className="p-6 shadow-lg border-0 bg-white/80 backdrop-blur">
              <h3 className="text-xl font-bold text-gray-900 mb-6">График платежей</h3>
          ...
          <TabsContent value="unit">
            <Card className="p-6 shadow-lg border-0 bg-white/80 backdrop-blur">
              <h3 className="text-xl font-bold text-gray-900 mb-6">Информация о квартире</h3>
              <div className="grid grid-cols-2 gap-6">
                <div>
                  <div className="space-y-4">
                    <div className="p-4 rounded-lg bg-blue-50 border border-blue-200">
                      <div className="text-sm text-gray-600 mb-1">Проект</div>
                      <div className="text-lg font-semibold text-gray-900">{unit.project}</div>
                    </div>
                    <div className="p-4 rounded-lg bg-teal-50 border border-teal-200">
                      <div className="text-sm text-gray-600 mb-1">Номер квартиры</div>
                      <div className="text-lg font-semibold text-gray-900">{unit.unitNumber}</div>
                    </div>
                    <div className="p-4 rounded-lg bg-blue-50 border border-blue-200">
                      <div className="text-sm text-gray-600 mb-1">Площадь</div>
                      <div className="text-lg font-semibold text-gray-900">{unit.area} м²</div>
                    </div>
                  </div>
                </div>
                <div>
                  <div className="space-y-4">
                    <div className="p-4 rounded-lg bg-amber-50 border border-amber-200">
                      ...
                      <div className="text-lg font-semibold text-gray-900">{unit.floor}</div>
                    </div>
                    <div className="p-4 rounded-lg bg-emerald-50 border border-emerald-200">
                      <div className="text-sm text-gray-600 mb-1">Комнат</div>
                      <div className="text-lg font-semibold text-gray-900">{unit.rooms}</div>
                    </div>
                    <div className="p-4 rounded-lg bg-amber-50 border border-amber-200">
                      <div className="text-sm text-gray-600 mb-1">Статус</div>
                      <Badge className="bg-blue-600 text-white">Забронирован</Badge>
                    </div>
                  </div>
                </div>
              </div>
          ...
          <TabsContent value="documents">
            <Card className="p-6 shadow-lg border-0 bg-white/80 backdrop-blur">
              <h3 className="text-xl font-bold text-gray-900 mb-6">Документы</h3>
              <div className="space-y-3">
                    ...
                    <div className="flex items-center justify-between">
                      <div className="flex items-center gap-4">
                        ...
                        <div>
                          ...
                          <div className="text-sm text-gray-500">
                            {new Date(doc.date).toLocaleDateString('ru-RU')} • {doc.size}
                          </div>
                        </div>
                      </div>
