...
const STATUS_OPTIONS = [
  { value: "active", label: "Активный", color: "bg-emerald-100 text-emerald-800" },
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          <div>
            ...
            <Input
              ...
              placeholder={formData.type === "company" ? 'ОсОО "Компания"' : "Иванов Иван Иванович"}
              required
              className="mt-1"
            />
          </div>
          ...
          <div className="grid grid-cols-2 gap-3">
            ...
            <div className="flex items-center gap-2 pt-6">
              <input
                ...
                onChange={(e) => setFormData({ ...formData, creditApproved: e.target.checked })}
                className="w-4 h-4"
              />
              ...
              clients.map((client) => (
                <TableRow key={client.id} className="hover:bg-gray-50">
                  ...
                  <TableCell className="text-sm">
                    {client.budget ? `${client.budget.toLocaleString()} с` : "—"}
                  </TableCell>
                  <TableCell>
        ...
        <AlertDialogContent>
          <AlertDialogHeader>
            ...
            <AlertDialogDescription>
              Это действие нельзя отменить. Клиент и все связанные данные будут удалены из системы.
            </AlertDialogDescription>
          </AlertDialogHeader>
          <AlertDialogFooter>
