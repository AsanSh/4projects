  ...
  return (
    <div className="p-6 space-y-6">
      ...
      <div className="flex items-center justify-between">
        <div>
          <h1 className="text-3xl font-bold text-gray-900">Контрагенты строительства</h1>
          <p className="text-gray-500 mt-1">Подрядчики, поставщики и заказчики</p>
        </div>
          ...
          <Card key={cp.id} className="hover:shadow-lg transition-shadow">
            <CardContent className="pt-6">
              ...
              <div className="mt-4 pt-4 border-t border-gray-100">
                <div className="text-sm text-gray-600">Общая сумма контрактов</div>
