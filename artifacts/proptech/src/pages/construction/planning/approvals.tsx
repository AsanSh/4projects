import { CheckSquare, User, ArrowRight, Clock, CheckCircle2, XCircle } from "lucide-react";
import { Badge } from "@/components/ui/badge";
import { Button } from "@/components/ui/button";

const MOCK_APPROVALS = [
  { id: 1, title: "Оплата подрядчику ООО «СтройПроф»", amount: 850000, currency: "KGS", initiator: "Марат А.", status: "pending", step: 1, steps: ["Прораб", "Финансовый директор", "Бухгалтер"], date: "2026-04-24" },
  { id: 2, title: "Закупка арматуры 32мм — 12 тонн", amount: 420000, currency: "KGS", initiator: "Нурлан К.", status: "approved", step: 2, steps: ["Прораб", "Финансовый директор", "Бухгалтер"], date: "2026-04-23" },
  { id: 3, title: "Аванс рабочим бригады №3", amount: 180000, currency: "KGS", initiator: "Аиша М.", status: "rejected", step: 0, steps: ["Прораб", "Финансовый директор", "Бухгалтер"], date: "2026-04-22" },
];
    ...
    <div>
      ...
      <div className="space-y-3">
        {MOCK_APPROVALS.map(ap => (
          <div key={ap.id} className="bg-white rounded-xl border border-gray-100 shadow-sm p-4">
            <div className="flex items-start justify-between mb-3">
              ...
              <div className="text-right">
                <div className="font-mono font-bold text-lg">{fmtFull(ap.amount)}</div>
              ...
              {ap.steps.map((step, i) => {
                ...
                return (
                  <div key={step} className="flex items-center gap-2 flex-1">
                    ...
                    {i < ap.steps.length - 1 && <ArrowRight className="w-3 h-3 text-gray-300 flex-shrink-0" />}
                  </div>
                );
              })}
            </div>
