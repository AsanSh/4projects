...
import { Plus, Search, UserCircle, Phone, Mail, Briefcase, HardHat } from "lucide-react";
  ...
  return (
    <div className="p-6 space-y-6">
      ...
      <div className="flex items-center justify-between">
        <div>
          <h1 className="text-3xl font-bold text-gray-900">Сотрудники строительства</h1>
          ...
          <Card key={emp.id} className="hover:shadow-lg transition-shadow">
            <CardContent className="pt-6">
              ...
              <div className="mt-4 pt-4 border-t border-gray-100">
                <div className="text-xs text-gray-500 mb-2">Активные проекты ({emp.projects.length})</div>
