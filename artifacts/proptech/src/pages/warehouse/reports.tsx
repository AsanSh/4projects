...
import { BarChart, Download, Calendar, TrendingUp, Package, FileText } from "lucide-react";
...
export default function WarehouseReports() {
  ...
  const movements = [
    { date: "2026-05-01", item: "Цемент М500", incoming: 50, outgoing: 35, balance: 115 },
    { date: "2026-05-02", item: "Арматура 12мм", incoming: 200, outgoing: 150, balance: 230 },
    { date: "2026-05-03", item: "Кирпич красный", incoming: 5000, outgoing: 3500, balance: 4800 },
    { date: "2026-05-04", item: "Песок речной", incoming: 80, outgoing: 60, balance: 140 },
    { date: "2026-05-05", item: "Щебень фр. 20-40", incoming: 100, outgoing: 75, balance: 185 },
  ];
    ...
    <div className="p-6 space-y-6">
      ...
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="text-gray-500 mt-1">Аналитические отчёты и статистика</p>
        </div>
        ...
        <CardContent className="pt-6">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
            <div className="space-y-2">
              <label className="text-sm font-medium text-gray-700">Тип отчёта</label>
            ...
            <table className="w-full">
              <thead>
                <tr className="border-b border-gray-200">
                  ...
                  <th className="text-right py-3 px-4 text-sm font-medium text-gray-600">Поступило</th>
                  <th className="text-right py-3 px-4 text-sm font-medium text-gray-600">Списано</th>
                  <th className="text-right py-3 px-4 text-sm font-medium text-gray-600">Остаток</th>
                </tr>
              </thead>
              <tbody>
                {movements.map((mov, idx) => (
                  <tr key={idx} className="border-b border-gray-100 hover:bg-gray-50">
                    ...
                    <td className="py-3 px-4 text-sm font-medium text-gray-900">{mov.item}</td>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
        <Card>
          <CardHeader className="pb-3">
            <CardTitle className="text-sm font-medium text-gray-600">Всего поступило</CardTitle>
          </CardHeader>
          <CardContent>
        ...
        <Card>
          <CardHeader className="pb-3">
            <CardTitle className="text-sm font-medium text-gray-600">Всего списано</CardTitle>
          </CardHeader>
          <CardContent>
        ...
        <Card>
          <CardHeader className="pb-3">
            <CardTitle className="text-sm font-medium text-gray-600">Чистое изменение</CardTitle>
          </CardHeader>
          <CardContent>
