    ...
    <div>
      <div className="flex items-center justify-between mb-6">
        <div>
          ...
          <p className="text-gray-500 text-sm mt-0.5">Поступления и расходы по месяцам</p>
        </div>
        ...
        <table className="w-full text-sm">
          <thead className="bg-gray-50">
            <tr>
              ...
              <th className="text-right p-3 font-medium text-gray-600">Поступления</th>
              <th className="text-right p-3 font-medium text-gray-600">Расходы</th>
              <th className="text-right p-3 font-medium text-gray-600">Нетто</th>
            </tr>
          </thead>
          <tbody>
            {months.map(([mon, vals]) => {
