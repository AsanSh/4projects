  ...
  return (
    <div>
      <div className="mb-6">
        ...
        <p className="text-gray-500 text-sm mt-0.5">Доходы и расходы по каждому владельцу</p>
      </div>
          ...
          <table className="w-full text-sm">
            <thead className="bg-gray-50">
              <tr>
                ...
                <th className="text-center p-3 font-medium text-gray-600">Объектов</th>
                <th className="text-right p-3 font-medium text-gray-600">Валовой доход</th>
                <th className="text-right p-3 font-medium text-gray-600">Расходы</th>
                <th className="text-right p-3 font-medium text-gray-600">Комиссия</th>
                <th className="text-right p-3 font-medium text-gray-600">Чистый</th>
              </tr>
            </thead>
            <tbody>
