    ...
    <div>
      <div className="flex items-center justify-between mb-6">
        <div>
          ...
          <p className="text-gray-500 text-sm mt-0.5">Просроченные начисления по арендаторам</p>
        </div>
        <Input
        ...
        <table className="w-full text-sm">
          <thead className="bg-gray-50">
            <tr>
              ...
              <th className="text-right p-3 font-medium text-gray-600">Начислено</th>
              <th className="text-right p-3 font-medium text-gray-600">Остаток</th>
              <th className="text-left p-3 font-medium text-gray-600">Срок оплаты</th>
          ...
          <tbody>
            {isLoading ? (
              ...
              <tr key={a.id} className="border-t hover:bg-gray-50">
                <td className="p-3">
                  <p className="font-medium text-gray-900">{a.tenant?.name || "Неизвестный"}</p>
