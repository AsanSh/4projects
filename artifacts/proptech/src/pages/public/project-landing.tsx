...
import {
  Building2, MapPin, Home, CheckCircle, Calendar, Phone,
  Mail, MessageSquare, Download, Image as ImageIcon, DollarSign,
  TrendingUp, Users, Award, Shield, Clock, ArrowRight
} from "lucide-react";
...
export default function ProjectLanding() {
  ...
  const project = {
    ...
    units: [
      { id: 1, rooms: 1, area: 45, price: 2700000, floor: "2-8", available: 12 },
      { id: 2, rooms: 2, area: 65, price: 4500000, floor: "2-8", available: 24 },
      { id: 3, rooms: 3, area: 85, price: 6200000, floor: "2-8", available: 18 },
    ],
    gallery: [
        ...
        <div className="absolute inset-0 container mx-auto px-6 flex items-center">
          <div className="max-w-2xl text-white">
            ...
            <div className="flex gap-4">
              ...
              <Button size="lg" variant="outline" className="bg-white/10 backdrop-blur border-white text-white hover:bg-white/20 h-14 px-8 text-lg">
      ...
      <div className="bg-gradient-to-r from-purple-600 to-teal-600 text-white py-8 shadow-xl">
        <div className="container mx-auto px-6">
          <div className="grid grid-cols-2 md:grid-cols-4 gap-8 text-center">
            <div>
              <div className="text-4xl font-bold mb-2">{project.totalUnits}</div>
              <div className="text-purple-100">Квартир в проекте</div>
            </div>
            <div>
              <div className="text-4xl font-bold mb-2">{Math.round(salesProgress)}%</div>
              <div className="text-purple-100">Уже продано</div>
            </div>
            <div>
              <div className="text-4xl font-bold mb-2">{project.priceFrom / 1000}k</div>
              <div className="text-purple-100">₸/м² от</div>
            </div>
            <div>
              <div className="text-4xl font-bold mb-2">{project.completionDate}</div>
          ...
          <div className="grid md:grid-cols-2 gap-12 items-center">
            <div className="space-y-6">
              <p className="text-lg text-gray-700 leading-relaxed">
                ...
                который сочетает в себе комфорт, безопасность и инновационные решения.
              </p>
              <p className="text-lg text-gray-700 leading-relaxed">
        ...
        <div className="mb-20">
          ...
          <div className="grid grid-cols-2 md:grid-cols-3 gap-6">
            {project.features.map((feature, idx) => (
              <Card key={idx} className="p-6 text-center hover:shadow-xl transition-shadow border-2 border-gray-100 hover:border-blue-300">
        ...
        <div className="mb-20">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            {project.units.map((unit) => (
              <Card key={unit.id} className="overflow-hidden shadow-lg border-0 hover:shadow-2xl transition-all hover:scale-[1.02]">
                  ...
                  <div className="space-y-3 mb-6">
                    ...
                    <div className="pt-3 border-t">
                      <div className="text-3xl font-bold text-blue-600 mb-1">
                        {new Intl.NumberFormat('ru-RU', { notation: 'compact' }).format(unit.price)} ₸
                      </div>
                ...
                <div className="space-y-6">
                  <div className="flex items-center gap-4">
                    ...
                    <div>
                      ...
                      <div className="text-lg font-semibold">+996 555 123 456</div>
                    </div>
                  </div>
                  <div className="flex items-center gap-4">
                    <div className="w-14 h-14 rounded-xl bg-white/20 backdrop-blur flex items-center justify-center">
                    ...
                    <div>
                      ...
                      <div className="text-lg font-semibold">info@proptech.kg</div>
                    </div>
                  </div>
                  <div className="flex items-center gap-4">
                    <div className="w-14 h-14 rounded-xl bg-white/20 backdrop-blur flex items-center justify-center">
                    ...
                    <div>
                      ...
                      <div className="text-lg font-semibold">Пн-Сб 9:00-19:00</div>
                    </div>
                  </div>
                </div>
              </div>
