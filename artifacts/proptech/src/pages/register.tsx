      ...
      >
        ...
        <div className="space-y-6 max-w-md">
          ...
          <p className="text-blue-200 text-base leading-relaxed">
            Зарегистрируйте вашу строительную компанию или девелоперский бизнес и получите полный доступ к управлению объектами, арендой и финансами.
          </p>
        ...
        <div className="w-full max-w-md">
          ...
          <div className="bg-white rounded-2xl shadow-sm border border-gray-100 p-8">
            {step === "company" ? (
              <>
                <div className="mb-6">
                  <h2 className="text-2xl font-bold text-gray-900">Данные организации</h2>
                  <p className="text-gray-500 text-sm mt-1">Шаг 1 из 2 — информация о вашей компании</p>
                </div>
              ...
              <>
                ...
                <form onSubmit={handleSubmit} className="space-y-4">
                  ...
                  <div>
                    <Label className="text-sm font-medium text-gray-700">Email для входа *</Label>
                    <Input
                      type="email"
                      value={form.email}
                      readOnly
                    ...
                    />
                    <p className="text-xs text-gray-400 mt-1">Используется email организации</p>
                  </div>
